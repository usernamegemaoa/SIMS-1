...
static void change_or_query_score();
...
/*
 * change or query student's score
 * if option == 2, query score
 * if option == 3, update score,
 * if option == 4, delete score
 */
static void change_or_query_score(int option)
{
    char *choices[3] = {"查询", "修改", "删除"};
